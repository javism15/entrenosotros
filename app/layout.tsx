...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: 'Entre Nosotros — Escape Room', description: 'Una habitación, cinco recuerdos y una historia por recuperar.', images: ['/og.png'] },
};
